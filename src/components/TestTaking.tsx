...
const TestTaking: React.FC<TestTakingProps> = ({ test, onSubmit, currentUser, onBack }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center text-sm text-gray-600 bg-gray-100 px-3 py-1 border-2 rounded-xl border-blue-600 outline-offset-4">
                <img src={generateIdenticon(currentUser.id)} className="size-10 mr-2 border rounded-xl border-blue-400 " />
              ...
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm text-gray-500">
                    {Math.round(((getAnsweredCount() + reviewedQuestions.size + 1) / filteredQuestions.length) * 100)}% Complete
                  </span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="bg-blue-600 h-2 rounded-full transition-all duration-300"
                    style={{ width: `${((getAnsweredCount() + reviewedQuestions.size + 1) / filteredQuestions.length) * 100}%` }}
                  />
                </div>
              </div>
